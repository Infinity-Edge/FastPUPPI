...
#from  PhysicsTools.NanoAOD import *
from  Configuration.StandardSequences.Eras import eras
#from  FastPUPPI.NtupleProducer.plugins.NPUTablesProducer_OLD import *
#from  DataFormats.L1TVertex.src.Vertex import 
...
process.source = cms.Source("PoolSource",
                            ...
                            #),
                            #fileNames = cms.untracked.vstring(dyfiles.DY_files
                            #),
                            fileNames = cms.untracked.vstring('file:./inputs106X_vbf_test.root'
                            ),
                            #fileNames = cms.untracked.vstring(dypu0files.DY_PU0_files
                            #),
                            #fileNames = cms.untracked.vstring(vbfpu0files.VBF_PU0_files
                            #),
...
process.endGen = cms.EDFilter("CandPtrSelector", src = cms.InputTag("genParticlesForMETAllVisible"), cut = cms.string("abs(eta) < 4.0"))
...
process.genMetEndTrue = process.genMetTrue.clone(src = cms.InputTag("endGen"))
...
'''
# Add pileup interaction
process.puTable = cms.EDProducer("NPUTablesProducer_OLD",
                src = cms.InputTag("slimmedAddPileupInfo"),
)
process.extraPFStuff.add(process.puTable)
'''
'''
...
process.extraPFStuff.add(process.finalGenParticles)
'''
...
process.outnano = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string("perfNano_test.root"),
    SelectEvents = cms.untracked.PSet(SelectEvents = cms.vstring('p')),

...
def makeCorrArray(tree, what, obj, ptCorrCut, etaCut, corr, _cache={}):
    ...
    if what == "metmht":
        ...
        return ret
    if "met" in what:
        #ret = makeCorrArray(tree, what, obj, ptCorrCut,    5.0, corr, _cache)
...
parser.add_option("-P","--plots", dest="plots", default="isorate,roc", help="Choose plot or comma-separated list of plots")
